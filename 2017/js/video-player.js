...
HeaderVideo.prototype.appendIframe = function() {
    ...
    $(this.settings.playTrigger).fadeOut(function(){
        $('.header-video').css('z-index' , '2000');
        $('.header-video__title , .header-video__sub-title, .color-bg').fadeOut();
    });
...
HeaderVideo.prototype.removeIframe = function() {
    ...
    $(this.settings.closeTrigger).fadeOut(function(){
        $('.header-video').css('z-index' , '0');
        $('.header-video__title  , .header-video__sub-title, .color-bg').fadeIn();
    });
