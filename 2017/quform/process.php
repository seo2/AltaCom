 ...
 */
$config['successMessage'] = 'Tu mensaje ha sido enviado, gracias.';
 ...
 * );
 */
$config['recipients'] = 'contacto@altacomunicacion.cl';
 ...
 * $config['from'] = '%email%';
 */
$config['from'] = 'no-contestar@altacomunicacion.cl';
 ...
 */
$config['subject'] = 'Mensaje desde Alta';
 ...
 * Validators: Required
 */
$name = new Quform_Element('name', 'Nombre');
$name->addFilter('trim');
...
$email->addValidator('email', array(
    'messages' => array('invalid' => 'Email invalido')
));
 ...
 * Validators: Required
 */
$message = new Quform_Element('message', 'Mensaje');
$message->addFilter('trim');
$message->addValidator('required', array(
    'messages' => array('required' => 'Campo obligatorio')
));
